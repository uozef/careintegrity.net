...
DEFAULT_RULES = [
    ...
    {
        "id": "RULE-008",
        "name": "Micro-claims flooding",
        "description": "Multiple small claims under $50 on the same day — potential claim splitting",
        "category": "Pattern",
        "enabled": True, "priority": 2,
        "conditions": [{"field": "total_amount", "operator": "<", "value": 50}, {"field": "hours", "operator": "<", "value": 1}],
        "logic": "ALL", "action": "flag", "severity": "medium", "created_at": "2025-01-15T00:00:00",
    },
    {
        "id": "RULE-009",
        "name": "Premium rate SIL billing",
        "description": "SIL services billed above $85/hour — exceeds standard price guide",
        "category": "Billing",
        "enabled": True, "priority": 1,
        "conditions": [{"field": "service_type", "operator": "contains", "value": "SIL"}, {"field": "rate_per_hour", "operator": ">", "value": 85}],
        "logic": "ALL", "action": "flag", "severity": "high", "created_at": "2025-02-01T00:00:00",
    },
    {
        "id": "RULE-010",
        "name": "Zero-hour billing",
        "description": "Claims with 0 hours but positive amount — administrative fraud",
        "category": "Billing",
        "enabled": True, "priority": 1,
        "conditions": [{"field": "hours", "operator": "<=", "value": 0}, {"field": "total_amount", "operator": ">", "value": 0}],
        "logic": "ALL", "action": "alert", "severity": "critical", "created_at": "2025-02-15T00:00:00",
    },
    {
        "id": "RULE-011",
        "name": "Early morning therapy",
        "description": "Therapy sessions starting before 7 AM — unlikely clinical schedule",
        "category": "Time",
        "enabled": True, "priority": 2,
        "conditions": [{"field": "service_type", "operator": "contains", "value": "Therapy"}, {"field": "start_hour", "operator": "<", "value": 7}],
        "logic": "ALL", "action": "flag", "severity": "medium", "created_at": "2025-03-01T00:00:00",
    },
    {
        "id": "RULE-012",
        "name": "Transport overcharge",
        "description": "Transport claims exceeding $200 per trip",
        "category": "Billing",
        "enabled": True, "priority": 2,
        "conditions": [{"field": "service_type", "operator": "contains", "value": "Transport"}, {"field": "total_amount", "operator": ">", "value": 200}],
        "logic": "ALL", "action": "flag", "severity": "medium", "created_at": "2025-03-15T00:00:00",
    },
    {
        "id": "RULE-013",
        "name": "Double-shift worker",
        "description": "Worker sessions spanning more than 12 hours continuously",
        "category": "Time",
        "enabled": True, "priority": 1,
        "conditions": [{"field": "hours", "operator": ">", "value": 12}],
        "logic": "ALL", "action": "alert", "severity": "critical", "created_at": "2025-04-01T00:00:00",
    },
    {
        "id": "RULE-014",
        "name": "Weekend personal care surge",
        "description": "Personal care on weekends over 5 hours — potential padding",
        "category": "Pattern",
        "enabled": True, "priority": 2,
        "conditions": [{"field": "is_weekend", "operator": "==", "value": True}, {"field": "service_type", "operator": "contains", "value": "Personal Care"}, {"field": "hours", "operator": ">", "value": 5}],
        "logic": "ALL", "action": "flag", "severity": "medium", "created_at": "2025-04-15T00:00:00",
    },
    {
        "id": "RULE-015",
        "name": "Extreme hourly rate",
        "description": "Any claim with rate above $120/hour — well above NDIS price guide",
        "category": "Billing",
        "enabled": True, "priority": 1,
        "conditions": [{"field": "rate_per_hour", "operator": ">", "value": 120}],
        "logic": "ALL", "action": "alert", "severity": "critical", "created_at": "2025-05-01T00:00:00",
    },
    {
        "id": "RULE-016",
        "name": "Capacity building overuse",
        "description": "Capacity building sessions over 4 hours — exceeds typical delivery",
        "category": "Billing",
        "enabled": True, "priority": 3,
        "conditions": [{"field": "service_type", "operator": "contains", "value": "Capacity"}, {"field": "hours", "operator": ">", "value": 4}],
        "logic": "ALL", "action": "flag", "severity": "low", "created_at": "2025-05-15T00:00:00",
    },
    {
        "id": "RULE-017",
        "name": "Support coordination excess",
        "description": "Support coordination claims over $300 per session",
        "category": "Billing",
        "enabled": True, "priority": 2,
        "conditions": [{"field": "service_type", "operator": "contains", "value": "Support Coordination"}, {"field": "total_amount", "operator": ">", "value": 300}],
        "logic": "ALL", "action": "flag", "severity": "high", "created_at": "2025-06-01T00:00:00",
    },
    {
        "id": "RULE-018",
        "name": "Community access long sessions",
        "description": "Community access sessions over 8 hours — potential fabrication",
        "category": "Time",
        "enabled": True, "priority": 2,
        "conditions": [{"field": "service_type", "operator": "contains", "value": "Community Access"}, {"field": "hours", "operator": ">", "value": 8}],
        "logic": "ALL", "action": "flag", "severity": "high", "created_at": "2025-06-15T00:00:00",
    },
]
